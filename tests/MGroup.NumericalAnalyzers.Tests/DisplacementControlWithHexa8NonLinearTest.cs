namespace MGroup.NumericalAnalyzers.Tests
{
	...
	public class DisplacementControlWithHexa8NonLinearTest
	{
		...
		public void DisplacementControlWithHexa8NonLinear()
		{
			...
			{
				model.NodesDictionary[iNode].Constraints.Add(new Constraint { DOF = StructuralDof.RotationZ, Amount = nodalDisplacement });
			}
			...
			// Solution
			var analyzer = (DisplacementControlAnalyzer)childAnalyzer;
